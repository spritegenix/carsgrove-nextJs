              ...
              <div className="row pb-50">
                ...
                <div className="col-lg-7 offset-lg-1">
                  <p className="text-lg-medium neutral-500">
                    Welcome to CarGrove, your trusted partner in car rentals.
              ...
              <div className="container">
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6 ps-lg-5">
                    ...
                    <h4 className="mb-4 neutral-1000">
                      CarGrove offers clear pricing and 24/7 great support.
                    </h4>
                    <p className="text-lg-medium neutral-500 mb-4">
                      ...
                      need it. At CarGrove, your satisfaction is our top
                      priority.
                    </p>
                    <div className="row">
                      <div className="col">
